...
**Implementation status:** M7 release-state — runtime + Stable **`1.0.0`** (pending annotated tag / GitHub Release).
...
| Latest published release | `v0.5.0` (next: `v1.0.0`) |
| WordPress Stable tag | `1.0.0` |
