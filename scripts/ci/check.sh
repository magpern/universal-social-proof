...
grep -q 'Version: 0.4.1' universal-social-proof.php || fail "expected version 0.4.1"
grep -q "define( 'USP_VERSION', '0.4.1' )" universal-social-proof.php || fail "USP_VERSION constant"
