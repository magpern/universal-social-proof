...
| **M2** | `0.2.0` | Selection engine + cache-safe REST; resolution budget; UUIDv4 `public_id`; response K ≤ 10. Plan: [M2-SELECTION-REST-PLAN.md](../milestones/M2-SELECTION-REST-PLAN.md) (**frozen**). Implementation complete on `feature/m2-selection-rest`; **not tagged until merge** | `v0.2.0` |
