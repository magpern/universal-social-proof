...
**Next published release:** **`v1.0.0`** (combined M6/M7 program — **no required public `v0.6.0`**).  
**Next work:** M6 implementation after freeze merge — [M6-M7-V1-PROGRAM.md](../milestones/M6-M7-V1-PROGRAM.md).
...
| **M6** | `0.6.0` (runtime) | Admin UX under WooCommerce + diagnostics. Plan: [M6-ADMIN-DIAGNOSTICS-PLAN.md](../milestones/M6-ADMIN-DIAGNOSTICS-PLAN.md) | **no required public tag** (Stable may lag at `0.5.0`) |
