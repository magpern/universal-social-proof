...
**M6:** **INTERNAL CLOSED** (runtime `0.6.0`; no public `v0.6.0`) — [M6-ADMIN-DIAGNOSTICS-CLOSURE.md](../milestones/M6-ADMIN-DIAGNOSTICS-CLOSURE.md).  
**M7:** release-state prepared — runtime + Stable `1.0.0`; `V1_ACCEPTANCE_GATE=PASS` — [M7-V1-ACCEPTANCE-GATE.md](../milestones/M7-V1-ACCEPTANCE-GATE.md).  
**Next published release:** **`v1.0.0`** (annotated tag + GitHub Release pending).
...
| **M7** | **`1.0.0`** | Hardening, acceptance, **first production-recommended release**. Plan: [M7-V1-HARDENING-RELEASE-PLAN.md](../milestones/M7-V1-HARDENING-RELEASE-PLAN.md); acceptance: [M7-V1-ACCEPTANCE-GATE.md](../milestones/M7-V1-ACCEPTANCE-GATE.md) | **`v1.0.0`** (release-state) |
