...
| **M3** | `0.3.0` | Front-end notification component (vanilla JS). Plan: [M3-STOREFRONT-TOASTER-PLAN.md](../milestones/M3-STOREFRONT-TOASTER-PLAN.md) (**frozen**). Implementation on `feature/m3-storefront-toaster`; **not tagged until merge** | `v0.3.0` |
